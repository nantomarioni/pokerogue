...
export const timedEvents: readonly TimedEvent[] = [
  {
    ...
    sprites: {
      ...
      trainerReplacements: [
        [TrainerType.BROCK, "jacinthe"],
        [TrainerType.MISTY, "jacinthe"],
        [TrainerType.LT_SURGE, "jacinthe"],
        [TrainerType.ERIKA, "jacinthe"],
        [TrainerType.JANINE, "jacinthe"],
        [TrainerType.SABRINA, "jacinthe"],
        [TrainerType.BLAINE, "jacinthe"],
        [TrainerType.GIOVANNI, "jacinthe"],
        [TrainerType.FALKNER, "jacinthe"],
        [TrainerType.BUGSY, "jacinthe"],
        [TrainerType.WHITNEY, "jacinthe"],
        [TrainerType.MORTY, "jacinthe"],
        [TrainerType.CHUCK, "jacinthe"],
        [TrainerType.JASMINE, "jacinthe"],
        [TrainerType.PRYCE, "jacinthe"],
        [TrainerType.CLAIR, "jacinthe"],
        [TrainerType.ROXANNE, "jacinthe"],
        [TrainerType.BRAWLY, "jacinthe"],
        [TrainerType.WATTSON, "jacinthe"],
        [TrainerType.FLANNERY, "jacinthe"],
        [TrainerType.NORMAN, "jacinthe"],
        [TrainerType.WINONA, "jacinthe"],
        [TrainerType.TATE, "jacinthe"],
        [TrainerType.LIZA, "jacinthe"],
        [TrainerType.JUAN, "jacinthe"],
        [TrainerType.ROARK, "jacinthe"],
        [TrainerType.GARDENIA, "jacinthe"],
        [TrainerType.MAYLENE, "jacinthe"],
        [TrainerType.CRASHER_WAKE, "jacinthe"],
        [TrainerType.FANTINA, "jacinthe"],
        [TrainerType.BYRON, "jacinthe"],
        [TrainerType.CANDICE, "jacinthe"],
        [TrainerType.VOLKNER, "jacinthe"],
        [TrainerType.CILAN, "jacinthe"],
        [TrainerType.CHILI, "jacinthe"],
        [TrainerType.CRESS, "jacinthe"],
        [TrainerType.CHEREN, "jacinthe"],
        [TrainerType.LENORA, "jacinthe"],
        [TrainerType.ROXIE, "jacinthe"],
        [TrainerType.BURGH, "jacinthe"],
        [TrainerType.ELESA, "jacinthe"],
        [TrainerType.CLAY, "jacinthe"],
        [TrainerType.SKYLA, "jacinthe"],
        [TrainerType.BRYCEN, "jacinthe"],
        [TrainerType.DRAYDEN, "jacinthe"],
        [TrainerType.MARLON, "jacinthe"],
        [TrainerType.VIOLA, "jacinthe"],
        [TrainerType.GRANT, "jacinthe"],
        [TrainerType.KORRINA, "jacinthe"],
        [TrainerType.RAMOS, "jacinthe"],
        [TrainerType.CLEMONT, "jacinthe"],
        [TrainerType.VALERIE, "jacinthe"],
        [TrainerType.OLYMPIA, "jacinthe"],
        [TrainerType.WULFRIC, "jacinthe"],
        [TrainerType.MILO, "jacinthe"],
        [TrainerType.NESSA, "jacinthe"],
        [TrainerType.KABU, "jacinthe"],
        [TrainerType.BEA, "jacinthe"],
        [TrainerType.ALLISTER, "jacinthe"],
        [TrainerType.OPAL, "jacinthe"],
        [TrainerType.BEDE, "jacinthe"],
        [TrainerType.GORDIE, "jacinthe"],
        [TrainerType.MELONY, "jacinthe"],
        [TrainerType.PIERS, "jacinthe"],
        [TrainerType.MARNIE, "jacinthe"],
        [TrainerType.RAIHAN, "jacinthe"],
        [TrainerType.KATY, "jacinthe"],
        [TrainerType.BRASSIUS, "jacinthe"],
        [TrainerType.IONO, "jacinthe"],
        [TrainerType.KOFU, "jacinthe"],
        [TrainerType.LARRY, "jacinthe"],
        [TrainerType.RYME, "jacinthe"],
        [TrainerType.TULIP, "jacinthe"],
        [TrainerType.GRUSHA, "jacinthe"],
      ],
    },
    textReplacements: [
